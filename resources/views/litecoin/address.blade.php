            ...
            <div class="row">
                <div class="lft-graph-blk col-md-12 col-sm-12 col-xs-12">
                    <ul>
                        ...
                        <li>
                            <h6>Received LTC</h6>
                            <p>{{($address->total_received)*0.00000001}}LTC</p>
                        </li>
                        </div>
                        ...
                        <li>
                            <h6>Sent LTC</h6>
                            <p>{{($address->total_sent)*0.00000001}}LTC</p>
                        </li>
                        </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <li>
                            <h6>Balance</h6>
                            <p>{{($address->balance)*0.00000001}}LTC</p>
                        </li>
                        </div>
      ...
      <span class="confirmations">
        ...
        &nbsp;
                                ...
                                <div class="col-md-5">
                                    ...
                                    <h4 class="text-center">{{count($tx->inputs)}} Input(s) Created</h4>

                                    @foreach($tx->inputs as $tx->input)

                                        @if(isset($tx->input->addresses[0]))


                                            <div class="txn-input truncate" >
                                                <strong>
                                                    {{($tx->input->output_value)*0.00000001}}
                                                </strong>

                                                from<br>
                                                <i class="fa fa-qrcode"></i>
                                                <a href="/ltc/address/{{$tx->input->addresses[0]}}/">{{$tx->input->addresses[0]}}</a>
                                ...
                                <div class="col-md-5">
                                    <h4 class="text-center">{{count($tx->outputs)}} Output Created</h4>

                                    @foreach($tx->outputs as $tx->output)
                                        ...
                                        @if(isset($tx->output->addresses[0]))
                                            ...
                                            <div class="txn-output truncate" id="output-index-0">
                                                <strong>
                                                    {{($tx->output->value)*0.00000001}} LTC
                                                </strong>

                                                to<br>
                                                <i class="fa fa-qrcode"></i>
                                                <a href="/ltc/address/{{$tx->output->addresses[0]}}">{{$tx->output->addresses[0]}}</a>
                                                <span class="truncate">
