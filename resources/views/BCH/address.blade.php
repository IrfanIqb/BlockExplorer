                                ...
                                <div class="col-md-5">
                                    <h4 class="text-center"> Output Created</h4>
                                           ...
                                           <div class="txn-output truncate" id="output-index-0">
                                                ...
                                                to<br>
                                                <i class="fa fa-qrcode"></i>
                                                <a href="/bch/address/{{$address->addrStr}}">{{$address->addrStr}}</a>
                                                <span class="truncate">
