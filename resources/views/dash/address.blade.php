            ...
            <div class="row">
                <div class="lft-graph-blk col-md-12 col-sm-12 col-xs-12">
                    <ul>
                        ...
                        <li>
                            <h6>Received Dash</h6>
                            <p>{{($address->total_received)*0.00000001}}Dash</p>
                        </li>
                        </div>
                        ...
                        <li>
                            <h6>Sent BTC</h6>
                            <p>{{($address->total_sent)*0.00000001}}Dash</p>
                        </li>
                        </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <li>
                            <h6>Balance</h6>
                            <p>{{($address->balance)*0.00000001}}Dash</p>
                        </li>
                        </div>
                                    ...
                                    @foreach($tx->inputs as $tx->input)
                                        ...
                                        @if(isset($tx->input->addresses[0]))
                                            ...
                                            <div class="txn-input truncate" >
                                                ...
                                                <a href="/dash/address/{{$tx->input->addresses[0]}}/">{{$tx->input->addresses[0]}}</a>
