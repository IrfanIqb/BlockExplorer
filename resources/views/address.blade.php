                ...
                <div class="lft-graph-blk col-md-12 col-sm-12 col-xs-12">
                    <ul>
                        <div class="col-md-4">
                            <li>
                                <h6>Received BTC</h6>
                                <p>{{($address->total_received)*0.00000001}}BTC</p>
                            </li>
                        </div>
                        ...
                        <li>
                            <h6>Sent BTC</h6>
                            <p>{{($address->total_sent)*0.00000001}}BTC</p>
                        </li>
                        </div>
                        ...
                        <li>
                            <h6>Balance</h6>
                            <p>{{($address->balance)*0.00000001}}BTC</p>
                        </li>
                        </div>
                    </ul>
                </div>
                                    ...
                                    @foreach($tx->inputs as $tx->input)
                                        ...
                                        @if(isset($tx->input->addresses[0]))
                                            ...
                                            <div class="txn-input truncate" >
                                                ...
                                                <a href="/btc/address/{{$tx->input->addresses[0]}}/">{{$tx->input->addresses[0]}}</a>
                                    ...
                                    @foreach($tx->outputs as $tx->output)
                                        ...
                                        @if(isset($tx->output->addresses[0]))
                                            ...
                                            <div class="txn-output truncate" id="output-index-0">
                                                <strong>
                                                    {{($tx->output->value)*0.00000001}} BTC
                                                </strong>

                                                to<br>
                                                <i class="fa fa-qrcode"></i>
                                                <a href="/btc/address/{{$tx->output->addresses[0]}}">{{$tx->output->addresses[0]}}</a>
                                                <span class="truncate">
