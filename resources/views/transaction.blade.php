            ...
            <div class="row">
                <div class="lft-graph-blk col-md-12 col-sm-12 col-xs-12">
                    <ul>
                        ...
                        <li>
                            <h6>Total Amount</h6>
                            <p>{{($transaction->total)*0.00000001}} BTC</p>
                        </li>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <li>
                            <h6>Fees</h6>
                            <p>{{number_format(($transaction->fees)*0.00000001,10, '.', ',')}} BTC</p>
                        </li>
                        </div>
                        ...
                        <div class="col-md-4">
                                ...
                                <li>
                            <h6>Confirmations</h6>
                            <p>{{$transaction->confirmations}} BTC</p>
                        </li>
                        </div>
      ...
      <span class="confirmations">
        ...
        &nbsp;
                            ...
                            <h4 class="text-center truncate">
                                ...
                                <a href="/btc/tx/{{$transaction->hash}}/">
                                    {{$transaction->hash}}
                                </a>
                                ...
                                @foreach($transaction->inputs as $tx)
                                    ...
                                    @if(isset($tx->addresses[0]))
                                        ...
                                        <div class="txn-input truncate" >
                                            ...
                                            <a href="/btc/address/{{$tx->addresses[0]}}/">{{$tx->addresses[0]}}</a>
                            ...
                            <div>
                                ...
                                <h4 class="text-center">
                                    ...
                                    {{($transaction->total)*0.00000001}} BTC
                                </h4>
